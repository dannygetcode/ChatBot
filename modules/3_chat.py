# Esta página muestra el chatbot con el que los usuarios pueden interactuar. El chatbot será accesible desde la página principal (`website.py`).
...
def obtener_respuesta(pregunta, modelo="gpt-3.5-turbo"):
    import openai
